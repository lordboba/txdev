...
export declare const FESTIVAL_CSS_VARS: { moonX: '--moon-x'; moonY: '--moon-y'; moonD: '--moon-d'; moonDx: '--moon-dx'; moonDy: '--moon-dy' /* pointer parallax, a transform on the sky and the moon button; --moon-x/-y are the anchor only */; night: '--festival-night'; slipX: '--slip-x'; slipY: '--slip-y'; slipTheta: '--slip-theta'; poemX: '--poem-x'; poemY: '--poem-y'; poemTheta: '--poem-theta'; colophonX: '--colophon-x'; colophonY: '--colophon-y'; translationX: '--translation-x'; translationY: '--translation-y' };
