...
- Builds product software, backend systems, and developer tools

## Experience

Currently building AI DevX at Decagon. Previously Scale AI, SafetyKit, and Ramp.

- **Decagon — Software Engineering Intern (Sep 2026 – Dec 2026, current):** Building AI developer experience.
...
| [DocuPilot](https://github.com/lordboba/docupilot)                   | Google Drive workflow tool for routing, summarizing, and updating documents from chat. | FastAPI, LangChain, Gemini API, React           |
...
- Interests: Developer tools, trust & safety, backend systems, startups
